CREATE TABLE [dbo].[TextApproved] (
    ...
    [LogTo]       VARCHAR (16) NULL,
    [UpdateCount] TINYINT      DEFAULT ((1)) NOT NULL,
    ...
    CONSTRAINT [FK_TextApproved_LogTo] FOREIGN KEY ([LogTo]) REFERENCES [dbo].[UserList] ([LogTo]) ON UPDATE CASCADE,
